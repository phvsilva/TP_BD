...
VALUES(NUM_SESSAO.NEXTVAL,TO_DATE('13/12/2018','DD/MM/YYYY'),'10H00','12H00',2,'P001','L1.1');
INSERT INTO SESSAO(NUM_SESSAO, DATA, HORA_INICIO, HORA_FIM, ID_DISCIPLINA, ID_PROFESSOR, ID_SALA)
VALUES(NUM_SESSAO.NEXTVAL,SYSDATE,'14H00','16H00',3,'P002','S2.1');
...
CREATE OR REPLACE TRIGGER INSPAGAMENTOSESSAO
  ...
  BEGIN
    SELECT P.NUM_PAGAMENTO INTO NRO_PAGAMENTO
    FROM PAGAMENTO P
...
-- TRIGGER DE ATUALIZAÇÃO AUTOMATICA DO VALOR TOTAL A PAGAR PELO ALUNO 
CREATE OR REPLACE TRIGGER ADDSESSAO_VALORTOTAL
    AFTER INSERT ON ALUNO_SESSAO
      FOR EACH ROW
  BEGIN
