...
CREATE VIEW V_PAGAMENTOS (NRO_PAGAMENTO, MONTANTE, DATA, ALUNO, MODO_PAGAMENTO)
AS
SELECT P.NUM_PAGAMENTO, P.VALOR_TOTAL, P.DATA_PAGAMENTO, P.NUM_ALUNO, MP.DESCRICAO
FROM PAGAMENTO P, MODO_PAGAMENTO MP
WHERE MP.ID_MODOPAG = P.ID_MODOPAG
